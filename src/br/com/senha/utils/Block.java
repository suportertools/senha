...
public class Block {
    ...
    private static BlockInterface blockInterface;
     ...
     */
    public static final String SINGLE_INSTANCE_SHARED_KEY = "$$" + TYPE + "Biometria$$\n";
    ...
    public static void setBlockInterface(BlockInterface block) {
        blockInterface = block;
    }

    private static void fireNewInstance() {
        if (blockInterface != null) {
            blockInterface.newInstanceCreated();
        }
    }
}
